...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(magit vue-mode js2-mode ace-window
     ace-jump-mode vterm vterm-toggle glsl-mode protobuf-mode kubernetes
     gdscript-mode ob-ipython quelpa use-package quelpa-use-package pyenv-mode)
...
you should place your code here."
  ...
  (define-key vterm-mode-map [C-right] 'vterm-send-M-f)
  (define-key vterm-mode-map [M-right] 'vterm-send-M-f)
  (define-key vterm-mode-map [C-backspace] 'vterm-send-backspace)
  ...
  (org-babel-do-load-languages
   ...
   '((ipython . t) (emacs-lisp . t) (shell . t)
   ))

  ;; Matrix.el has no MELPA candidate, so install from source with quelpa:
