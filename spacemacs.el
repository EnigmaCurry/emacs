...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(magit vue-mode js2-mode ace-window ace-jump-mode vterm vterm-toggle pdf-tools)
