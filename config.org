...
(use-package ox-hugo
  ...
  :after ox
  :init
  (setq org-hugo-external-file-extensions-allowed-for-copying '(org jpg jpeg tiff png svg pdf odt))
  (defconst my/hugo-dir (expand-file-name "~/git/blog") 
    "Root hugo site directory")
  (defconst my/hugo-org-content-dir (expand-file-name "static/org" my/hugo-dir)
      ...
      (when (and fname
        ...
        (save-excursion
          ...
          (if (< (how-many "^#\\+TITLE:") 1)
            ...
            (if (< (how-many "^#\\+DATE:") 1)
                (message "Unable to export as the Org file is missing the #+DATE keyword.")
