...
# If you making this config your own, personalize these variables:
# Your name and email:
#+AUTHOR: EnigmaCurry
#+EMAIL: ryan@enigmacurry.com
# Your URL to the HTML export of this config:
#+LINK: web https://emacs.rymcg.tech
# Your public git forge page for this config:
#+LINK: git-repo https://github.com/EnigmaCurry/emacs
# Your branch specific file blob URL for this config:
...
Some of the default values are tailored for the author (EnigmaCurry).
You should change these values to suit your own environment by running
=M-x my/custom-settings=. Enter the =My Path Settings= sub-menu, and
